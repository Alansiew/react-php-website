...

{
    ...
    if ($type == 'DVD') {
        ...
        $insertProduct2 = mysqli_query($db_conn, "INSERT INTO `dvd` (`id`,`size`) VALUES ('$last_id',' $size')");
    ...
    elseif ($type == 'Book') {
        ...
        $insertProduct3 = mysqli_query($db_conn, " INSERT INTO `book` (`id`,`weight`) VALUES ('$last_id',' $weight')");
        echo $last_id;
        if ($insertProduct3) {
    ...
    elseif ($type == 'Furniture') {
        ...
        $insertProduct4 = mysqli_query($db_conn, "INSERT INTO `furniture` ( `id`, `height`,`width`,`length`) VALUES ('$last_id',' $height',' $width',' $length')");
